<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 pageEncoding="UTF-8"%>
 <%@page import="entity.ListAllmessage" %> 
...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      ...
      <ul>
        <li>用户列表</li>
        <li class="func" dataType='html' dataLink='msn.htm' iconImg='images/msn.gif'>添加新普通用户</li>
        <li>商品分类</li>
        <li>用户评论</li>
        <li>商品回收站</li>
        <li>库存管理 </li>
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-users"> 留言管理</ul>
      
      <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">留言列表</a></dl>
      <!--这里打开的是新页面-->
          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-title">留言用户</th>
                <th class="table-type">留言内容</th>
                <th class="table-type">留言时间</th>
                <th width="130px" class="table-set">操作</th>
              </tr>
            </thead>
            <tbody>
             <%for(int i=0;i<listmessage.size();i++){
            	ListAllmessage message=(ListAllmessage) listmessage.get(i);
            	%>
              <tr>
                <td><input type="checkbox" /></td>
                
                <td id=messageno<%=i%>><%=message.getMessage_id()%></td>
                <td><a href="#"><%=message.getPno()%></a></td>
                <td><%=message.getMessage_content()%></td>
                <td><%=message.getMessage_time()%></td>
                <td>
                    ...
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-round" onclick="delmessage<%=i%>();return false;" title="删除留言"><span class="am-icon-trash-o" ></span></button>
                    </div>
                  </div>
...
function delmessage<%=i%>() {
	var thisgetID=document.getElementById("messageno<%=i%>").innerHTML;
	window.location.href="Deletemessage?thisgetID="+thisgetID;
