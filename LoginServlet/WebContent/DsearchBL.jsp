...
%>
    ...
    <div class="main_message">
     ...
     <label style="color:white;">
      ...
      <form action="getSearchSessionPID.do" method="post" id="getPID" onsubmit="javascript:return setcok(this);">
      <input placeholder="就诊患者身份ID" id="PID" name="PID" type="PID" required="" style="background-color: transparent;float:left;color:white;">
